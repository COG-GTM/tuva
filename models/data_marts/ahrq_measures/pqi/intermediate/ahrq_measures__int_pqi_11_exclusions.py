...
def run(spark: SparkSession) -> DataFrame:
    ...
    sickle_cell = (
        ...
        .join(
            ...
            & (F.col("pqi.value_set_name") == F.lit("sickle_cell_anemia_or_hb-s_disease_diagnosis_codes"))
            & (F.col("pqi.pqi_number") == F.lit("11")),
            "inner",
        )
        ...
        .select(
            ...
            F.col("c.data_source"),
            F.lit("sickle cell").alias("exclusion_reason"),
        )
        .distinct()
    )
